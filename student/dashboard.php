  ...
  <div class="container-fluid">
    ...
    <?php
      ...
      if ($query && mysqli_num_rows($query) > 0) {
          ...
          // If no record found, initialize $attendance as an empty array
          $attendance = [];
      }
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form action="" method="post">
              <?php
              if (!isset($attendance[$current_date]) || empty($attendance[$current_date]['signin_at']) || !empty($attendance[$current_date]['signout_at'])) {
